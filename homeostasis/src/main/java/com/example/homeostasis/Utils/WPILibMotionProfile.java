package com.example.homeostasis.Utils;
...
public class WPILibMotionProfile {
	...
	private org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.Constraints m_constraints;
	private org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State m_initial;
	private org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State m_goal;
	 ...
	 */
	public WPILibMotionProfile(org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.Constraints constraints, org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State goal, org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State initial) {
	 ...
	 * @param goal        The desired state when the profile is complete.
	 */
	public WPILibMotionProfile(org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.Constraints constraints, org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State goal) {
		this(constraints, goal, new org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State(0, 0));
	}
	 ...
	 * @param goal    The desired state when the profile is complete.
	 */
	private static boolean shouldFlipAcceleration(org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State initial, org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State goal) {
	 ...
	 */
	public org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State calculate(double t) {
		org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State result = new org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State(m_initial.position, m_initial.velocity);
	...
	private org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State direct(org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State in) {
		org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State result = new org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State(in.position, in.velocity);
	...
	public static class State {
		...
		public boolean equals(Object other) {
			if (other instanceof org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State) {
				org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State rhs = (org.firstinspires.ftc.teamcode.WPILIB.TrapezoidProfile.State) other;
