...
public class stateController extends stateRegulator {
     ...
     */
    public stateController(homeostasis.systems.plant plant, state regulatorGain) {
        super(plant, regulatorGain);
    }
    public stateController(homeostasis.systems.plant plant, state regulatorGain, double Kv) {
        super(plant, regulatorGain);
        this.Kv = Kv;
    }
