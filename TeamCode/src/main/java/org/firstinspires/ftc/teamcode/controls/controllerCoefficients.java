...
public class controllerCoefficients {
	...
	public static final PIDFCoefficients compBotTurn = new PIDFCoefficients(0.8, 0.01, 0.05,0,0,0.2785000000000002);
	...
	public static final PIDFCoefficients protoBotDrive = new PIDFCoefficients(0.08238, 0, 0.00993, 0, 0,0.04770000000000017);
