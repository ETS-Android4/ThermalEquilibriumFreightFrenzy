...
public class controllerCoefficients {
	...
	public static final PIDFCoefficients compBotTurn = new PIDFCoefficients(0.9, 0.25, 0,0,0,0.1);
	...
	public static final PIDFCoefficients slideCoefficients = new PIDFCoefficients(0.011, 0.22, 0);
